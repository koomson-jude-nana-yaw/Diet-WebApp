...
(1, 'Nutritionist', '2022-10-30 18:09:46', NULL),
(2, 'Internal Medicine', '2022-10-30 18:09:57', NULL),
(3, 'Dietician', '2022-10-30 18:10:18', NULL),
(4, 'Gym Instructor', '2022-10-30 18:10:28', NULL),
...
INSERT INTO `tblmedicalhistory` (`ID`, `PatientID`, `BloodPressure`, `BloodSugar`, `Weight`, `Condition`, `MedicalPres`, `CreationDate`) VALUES
(1, 1, '80/120', '120', '85', 'Obesse', 'Test', '2022-11-06 13:19:41');
...
(1, 'aboutus', 'About Us', '<ul style=\"padding: 0px; margin-right: 0px; margin-bottom: 1.313em; margin-left: 1.655em;\" times=\"\" new=\"\" roman\";=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" center;=\"\" background-color:=\"\" rgb(255,=\"\" 246,=\"\" 246);\"=\"\"><li style=\"text-align: left;\"><font color=\"#000000\">Welcome to our diet web app! We are dedicated to helping you achieve your health and wellness goals through personalized nutrition and lifestyle guidance. Our web app is designed to provide you with a comprehensive and easy-to-use platform to manage your diet and nutrition. Whether you are looking to lose weight, build muscle, or simply improve your overall health, our app can help you track your progress and stay on track.

With our app, you will have access to a wide range of features and tools, including personalized meal plans, calorie tracking, nutritional information for thousands of foods, exercise tracking, and more. Our expert nutritionists have created customized meal plans based on your personal goals, dietary restrictions, and preferences.

We understand that making lasting changes to your diet and lifestyle can be challenging, which is why we also offer motivational and educational resources to keep you inspired and informed. Our app provides access to a supportive community of like-minded individuals who are also on their health and wellness journey.

At our diet web app, we are committed to empowering you to make healthy choices and achieve your goals. So why wait? Start your journey towards a healthier, happier you today!.</font></li><li style=\"text-align: left;\"><font color=\"#000000\"></font></li></ul>', NULL, NULL, '2020-05-20 07:21:52', NULL),
